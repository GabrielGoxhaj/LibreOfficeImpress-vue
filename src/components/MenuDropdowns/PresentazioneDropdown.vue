...
.dropdownPresentazione a div {
    display: flex;
    align-items: center;
    padding: auto;
}

.dropdownPresentazione a div img {
    margin-right: 14px;
    max-width: 16px;
    max-height: 16px;
}

.dropdownPresentazione a:hover:not(.disabled) {
...
.dropdownPresentazione a:hover.disabled {
