<template>
    <div class="menuIconLibreOfficeImpress">
        <div class="riga1">
            <button @click="console.log('Nuovo!')"><img src="../assets/Impress/icons/icons_menu/nuovo.png"></button><button class="dropdown" @click="console.log('NuovoDropdown!')" @mouseover="addHoverClass" @mouseout="removeHoverClass"><img src="../assets/Impress/icons/icons_menu/dropdown-icon.png"></button>
            ...
            <div class="vl" />
            <button @click="console.log('Espandi')" class="espandi"><img src="../assets/Impress/icons/icons_menu/espandi.png"></button>
            <button @click="console.log('Espandi')" class="espandi"><img src="../assets/Impress/icons/icons_menu/espandi.png"></button>
        </div>
        <div class="riga2">
